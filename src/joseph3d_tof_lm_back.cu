                          ...
                          int threads_per_block)
{
    ...
    handle_cuda_input_array(projection_values, &d_projection_values.ptr, projection_values_size, d_projection_values.owns, device_id, cudaMemAdviseSetReadMostly);
